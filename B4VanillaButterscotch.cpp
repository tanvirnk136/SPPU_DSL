...
int main()
{
  ...
  for(i=1; i<=no; i++)
  {
     if(i == 1)
     {
        cout<<"\n\nEnter "<<m<< " Students of SE Comp : ";
        headU = createSLL(m, headU);
           cout<<"\n";
        displaySLL(headU);
     }
     if(i == 2)
     {
        cout<<"\n\nEnter "<<v<<" Students who like Vanilla Icecream: ";           
        headA = createSLL(v, headA);
           cout<<"\n";
        displaySLL(headA);
     }
     if(i == 3)
     {
        cout<<"\n\nEnter "<<b<<" Students who like Butterscotch Icecream: ";                 
        headB = createSLL(b, headB);
           cout<<"\n";
        displaySLL(headB);            
     }
  }
